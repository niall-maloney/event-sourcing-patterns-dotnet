...
public class CassandraLedgersRepository : ILedgersRepository
{
    ...
    public CassandraLedgersRepository()
    {
        ...
        _session = cluster.Connect("processor");
    ...
    {
        //CREATE TABLE IF NOT EXISTS processor.ledgers ( ledger text PRIMARY KEY, pendingAmount decimal, committedAmount decimal, lastStreamPosition varint );
        _session.Execute(
