...
public record Payment(string Id, string Iban, decimal Amount, string Reference, string Status, ulong Version)
{
    ...
    public static IEnumerable<Payment> Map(IEnumerable<PaymentRow> rs) =>
        rs.Select(r => new Payment(r.PaymentId, r.Iban, r.Amount, r.Reference, r.Status, r.Version));
}